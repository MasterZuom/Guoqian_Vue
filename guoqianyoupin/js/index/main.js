    ...
    wx.miniProgram.getEnv(function(res) {
        if(!res.miniprogram){
            var useInfo = {
                ...
                issueDate:getParam('issueDate'),
                expiration:getParam('expiration'),
                socialUserId:getParam('socialUserId'),
